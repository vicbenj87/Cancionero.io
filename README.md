...
- **`index.html`** — la web pública: índice de canciones y vista de diapositivas para proyectar.
...
| Letra completa (vertical, solo scroll) | Botón **Letra completa** · tecla `L` |
| Pantalla en negro | `B` o `.` |
| Pantalla completa | `F` |
| Volver al índice | `Esc` |

Las flechas y la barra superior se desvanecen tras unos segundos sin actividad y vuelven
al mover el ratón. El tiempo se ajusta en `visor.ocultarControlesTrasMs`.
...
index.html#/c/12/3      la canción 12, diapositiva 3
```
